"""
Django settings for hjhdndd_1 project.
...
WSGI_APPLICATION = 'hjhdndd_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hjhdndd_1 API",
    "DESCRIPTION": "API documentation for hjhdndd_1 App",
    "VERSION": "v1",
}
